...
- Custom scrollbars don't work on certain browsers that do not support the `:--webkit-scrollbar` pseudo-component (Firefox and Edge in particular). I have no way of solving this as it is a browser issue and not one with my coding.
- `[!column]` callout won't work in Quartz despite working fine in Obsidian. Didn't manage to fix the issue yet.