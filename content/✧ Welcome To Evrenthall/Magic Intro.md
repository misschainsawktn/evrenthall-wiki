...
As it is commonly understood, magic originates from the so-called “**Fluxes of Magic**” (or simply Fluxes), which in turn are created by the deities of Evrenthall in various ways; said Fluxes can then be channeled and used by magic users in order to cast spells of various effects and magnitude.
